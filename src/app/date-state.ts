...
export const COMPLIMENTS: string[] = [
  ...
  'Я готов пройти на руках, лишь бы ты сказала «да»',
  'Самая красивая гимнастка в этом интернете',
  'С тобой даже понедельник — выходной',
  'Твой инстаграм — мой любимый профиль 📸',
  'Свободна? Это лучшая новость недели 🎉',
  'Ставлю лайк ещё до того, как ты выложишь 😍',
  'Если красота — это спорт, у тебя золото 🥇',
  'Растяжка — у тебя, а тает — моё сердце',
  'Идеальная техника и идеальная улыбка',
  'Ты — повод проверять телефон каждые 5 минут 📱',
  'За такую улыбку я готов на любой ресторан 🍽️',
  'Лучше любой стойки на руках — твоя улыбка',
  'Кажется, я нашёл своё «золото» ✨',
];
