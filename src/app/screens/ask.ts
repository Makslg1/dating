...
@Component({
  ...
  template: `
    <section class="screen">
      ...
      <div class="about">
        <p><b>Привет, я Максим 👋</b> Мне 40 — родился 7 января, упрямый, но обаятельный Козерог 😄</p>
        <p>
          Старший инженер-программист, работаю в сфере АСУТП. До этого 9 лет был
          senior-разработчиком на Upwork. Этот сайт, как понимаешь, тоже моих рук дело 😎
        </p>
        <p>Обожаю путешествовать — объездил кучу стран, а форму держит кроссфит 🏋️</p>
        <p>
          И самое приятное: мы с тобой в одном городе — Омске. Сам я на левом берегу,
          район Фестиваля, так что доехать до тебя — вообще не вопрос 🚗
        </p>
        <p>
          А зову именно тебя не случайно: твоя сестра рассказала, что ты искренняя и свободная,
          показала пару фото — и я понял, что очень хочу познакомиться по-настоящему.
          Без спешки и без неловкости.
        </p>
...
export class AskScreen implements OnInit, OnDestroy {
  ...
  readonly noTexts = [
    ...
    'Я уже накачал велик 🚲',
    'Столик забронирован…',
    'Кот в сапогах плачет 🐱',
    'Я ради тебя на руках пройду 🤸',
    'Даю скидку 100% 😅',
    'Соглашайся, я нервничаю',
    'Последний шанс…',
    'Ладно, спрошу иначе 👉',
    'Эта кнопка всё равно ведёт к «Да» 😏',
    'Поздно, я уже влюбился ❤️',
  ];
